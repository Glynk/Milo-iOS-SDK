...
SWIFT_CLASS("_TtC7MiloSdk17APJTextPickerView")
...
@interface APJTextPickerView (SWIFT_EXTENSION(MiloSdk)) <UIPickerViewDelegate>
- (NSString * _Nullable)pickerView:(UIPickerView * _Nonnull)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
@end


@interface APJTextPickerView (SWIFT_EXTENSION(MiloSdk)) <UIPickerViewDataSource>
